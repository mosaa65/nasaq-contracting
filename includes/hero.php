<section class="hero services-hero-slider">
    ...
    <div class="hero-content">
        <div class="hero-kicker">
            مقاولات عامة · تشطيبات داخلية وخارجية · تصميم وتنفيذ واجهات حديثة
        </div>

        <h1 class="hero-title">
            نصنع الفرق <span>قبل</span> و<span>بعد</span><br>
            مع <span>قبل و بعد مقاولات عامة</span>.
        </h1>

        <p class="hero-subtitle">
            حلول متكاملة من التخطيط إلى التسليم، بتفاصيل مدروسة وجودة تنفيذ عالية.
        </p>
        ...
        <div class="hero-badges">
            ...
            <span>جودة تشطيبات عالية</span>
            <span>التزام بالمواعيد والعقود</span>
        </div>
    </div>
</section>
