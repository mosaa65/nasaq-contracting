    ...
    <div class="section-wrapper">
        ...
        <div class="ba-grid">
            ...
            <article class="ba-card"
                     data-ba-card
                     data-state="after"
                     data-title="تحويل جذري لمساحة داخلية"
                ...
                <div class="ba-image-wrap" data-ba-open>
                    ...
                    <img
                        ...
                        data-before="assets/befor_after_images/1/IMG_1407.JPG"
                        data-after="assets/befor_after_images/1/IMG_1408.JPG"
                    >
                ...
                <div class="ba-content">
                    <h3 class="ba-project-title">تحويل جذري لمساحة داخلية</h3>
                    <p class="ba-project-text">
                        إعادة تأهيل كاملة لمساحة خام بجدران مكشوفة وأرضيات متضررة، وتحويلها إلى تصميم عصري فاخر
                        يجمع بين الرخام والإضاءة المخفية والخشب الدافئ، لتصبح المساحة أنيقة ومتناغمة في كل التفاصيل.
                    </p>
                </div>
            </article>
            ...
            <article class="ba-card"
                     data-ba-card
                     data-state="after"
                     data-title="تصميم ركن تلفاز فاخر"
                ...
                <div class="ba-image-wrap" data-ba-open>
                    ...
                    <img
                        ...
                        data-before="assets/befor_after_images/2/IMG_1405.JPG"
                        data-after="assets/befor_after_images/2/IMG_1406.JPG"
                    >
                ...
                <div class="ba-content">
                    <h3 class="ba-project-title">تصميم ركن تلفاز فاخر</h3>
                    <p class="ba-project-text">
                        تحويل ركن خرساني خام إلى وحدة تلفاز رخامية متكاملة بالإضاءة المخفية والخشب الدافئ،
                        ليصبح نقطة تركيز أنيقة تضيف فخامة وعمقاً بصرياً لغرفة المعيشة.
                    </p>
                </div>
            </article>
            ...
            <article class="ba-card"
                     data-ba-card
                     data-state="after"
                     data-title="تحويل منصة خرسانية إلى بار رخامي فاخر"
                ...
                <div class="ba-image-wrap" data-ba-open>
                    ...
                    <img
                        ...
                        data-before="assets/befor_after_images/3/IMG_1409.JPG"
                        data-after="assets/befor_after_images/3/IMG_1410.JPG"
                    >
                ...
                <div class="ba-content">
                    <h3 class="ba-project-title">تحويل منصة خرسانية إلى بار رخامي فاخر</h3>
                    <p class="ba-project-text">
                        تطوير منصة خرسانية بسيطة إلى بار رخامي أنيق بتفاصيل منحنية وإضاءة محيطية،
                        يربط بصرياً بين منطقة الجلوس والمطبخ المفتوح ويضيف للمساحة لمسة فاخرة وعملية في آن واحد.
                    </p>
                </div>
            </article>
        ...
        <!-- لايت بوكس لعرض الصورة منبثقة مع أزرار يمين/يسار -->
